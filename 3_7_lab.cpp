...
public :
    ...
    media(string _name,string _author,int _length, int _time){ // 4 parameter constructor
        name = _name;
        author = _author;
        length = _length;
        playing_sec = _time;
...
public :
    ...
    movie(string _name,string _author,int _length, int _time, string _director, string _actor) : media(_name,_author,_length, _time){ // 5 parameter constructor
        director = _director;
        main_actor = _actor;
    }
...
public :
    ...
    podcast(string _name,string _author,int _length, string _station) : media(_name,_author,_length){ // 4 parameter constructor
        station = _station;
    }
